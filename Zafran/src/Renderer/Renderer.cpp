...
namespace Zafran
{
    ...
    unsigned int Renderer::RayTraceSurfaceVB1 = 0;
    unsigned int Renderer::RayTraceSurfaceVB2 = 0;
    ...
    void Renderer::ColorBackground(Color color, SDL_Renderer* renderer)
    {
        SDL_SetRenderDrawColor(renderer, color.r, color.g, color.b, color.a);
        SDL_RenderClear(renderer);
    };

    int Renderer::GetDefaultShaderProgram() { return DefaultShaderProgram; };
